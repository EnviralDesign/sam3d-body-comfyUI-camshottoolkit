...
from .processing.save_meshes import NODE_CLASS_MAPPINGS as SAVE_MAPPINGS
from .processing.save_meshes import NODE_DISPLAY_NAME_MAPPINGS as SAVE_DISPLAY_MAPPINGS

NODE_CLASS_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS = {}

for mappings in [LOAD_MAPPINGS, PROCESS_MAPPINGS, VIS_MAPPINGS, SAVE_MAPPINGS]:
    NODE_CLASS_MAPPINGS.update(mappings)

for mappings in [LOAD_DISPLAY_MAPPINGS, PROCESS_DISPLAY_MAPPINGS, VIS_DISPLAY_MAPPINGS, SAVE_DISPLAY_MAPPINGS]:
